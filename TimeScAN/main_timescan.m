...
global SCRSZ WHFIG WHTRCFIG POSITIONFIG POSITIONTRCFIG POSITIONROISELECT FONTSIZE...
    ...
    POSTPOINTS LW1 LW2 XTYPE FFORMAT XLINEALPHA SAVEPATH FTIMEVEC FNAME LOCAREAINFO SOMAINFO...
    PXCLASSCNT RANGE FTIMEPREV PEAKWIN RANDNOISEPTS RANDMAXTHRESH
...
ISBGSUB = false;
evINFO = struct();
BASEPOINTS = round(0.5/FTIME);
PREPOINTS = BASEPOINTS;
POSTPOINTS = round(1.5/FTIME);
XTYPE = 's';
FFORMAT = '.xlsx';
XLINEALPHA = 0.1;
SAVEPATH = '';
...
PXCLASSCNT =[];
RANGE = [];
PEAKWIN = 3; % Frames after threshold onset in which peak is detected
RANDNOISEPTS = 50;
RANDMAXTHRESH = 1;
