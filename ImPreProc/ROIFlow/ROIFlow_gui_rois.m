...
whlist2 = [2 14].*whunits;
whlist3 = [0.7 14].*whunits;
whbut = [2 1.5].*whunits;
...
txtlist1_pos_2 = [txtlist2_pos_1(1)+whlist3(1)+hvspacer(1)*0.75 hvspacer(2)*1.2+whbutsm(2) whlist2];
...
txt_pos_1 = [txtlist1_pos_1(1) txtlist1_pos_1(2)+whlist2(2)+0.1*hvspacer(2) whtxt];
...
butsm_pos_1 = [txtlist1_pos_1(1)+hvspacer(1)*0.3 hvspacer(2) whbutsm];
...
txt_1 = uicontrol('parent', mainfig, 'style', 'text','units', 'normalized','position', txt_pos_1,'string', 'Background set','FONTSIZE', FONTSIZE);
...
txtlist_1 = uicontrol('parent', mainfig, 'style', 'text','units', 'normalized','position', txtlist1_pos_1,'FONTSIZE', FONTSIZE-2, 'string','','BackgroundColor', txtbgcol, 'ForegroundColor', txtfgcol);
txtlist_2 = uicontrol('parent', mainfig, 'style', 'text','units', 'normalized','position', txtlist2_pos_1,'FONTSIZE', FONTSIZE-2, 'string','','BackgroundColor', txtbgcol, 'ForegroundColor', txtfgcol);
...
butsm_1 = uicontrol('parent', mainfig, 'style', 'pushbutton','units', 'normalized','position', butsm_pos_1,'string', 'Check BG','FONTSIZE', FONTSIZE, 'callback', {@cb_butsm});
...
SELECTED = hObj.Value;
if numel(SELECTED) == 1
    if ~isnan(INFOSTRUCT(SELECTED).bg_threshold),but_6.BackgroundColor = setcol; else, but_6.BackgroundColor = unsetcol; end
